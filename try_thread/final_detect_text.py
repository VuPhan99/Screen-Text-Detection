...
from read_net_east import readNetEAST
...
start = time.time()
#Get data from threadNetEST
with concurrent.futures.ThreadPoolExecutor() as executor:
    future = executor.submit(readNetEAST, args, blob, layerNames)
    (scores, geometry) = future.result()
end = time.time()
...
for (startX, startY, endX, endY) in boxes:
	...
	with concurrent.futures.ThreadPoolExecutor() as executor:
		translation = executor.submit(translateText, text)
